...
##########################################
# Desriptive Statistics (Betimsel Istatistikler)
##########################################
...
##########################################
# Confidence Interval (Güven Araligi)
##########################################

# Tips Veri Setindeki Sayisal Degiskenler icin Güven Araligi
...
sms.DescrStatsW(df["fare"].dropna()).zconfint_mean()
